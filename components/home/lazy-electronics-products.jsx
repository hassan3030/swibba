...
/**
 * Electronics Products Section Component
 * Displays electronics category products
...
const LazyElectronicsProducts = ({ showSwitchHeart, t }) => {
  const fetchElectronics = useCallback(
    () => getProducts({ category: "electronics" }, { sort: "-date_created", limit: 15 }),
    []
  )
...
export default LazyElectronicsProducts
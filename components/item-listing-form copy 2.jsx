...
export function ItemListingForm() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="flex items-center justify-center min-h-screen w-full py-2 px-2 md:px-8"
    >
      <div className="w-full">
        <Form {...form}>
          <form
            ...
            className="space-y-2"
          >
            <div className="grid gap-2 md:grid-cols-1 rounded-2xl shadow-xl bg-white p-6 md:p-10">
              {step === 1 && (
                <motion.div className="space-y-2" variants={itemVariants}>
                      ...
                      <Card className="rounded-xl shadow-md border border-gray-100">
                        ...
                        <CardContent className="space-y-2">
                          <motion.div variants={buttonVariants}  whileTap="tap">
                            <Button onClick={getCurrentPosition} disabled={isGettingLocation} className="w-full py-2 rounded-lg bg-teal-50 text-teal-700 font-medium hover:bg-teal-100 transition-all hover:scale-[1.02]">
                              {isGettingLocation ? (
                                <>
                  ...
                  <Button
                    ...
                    className="w-full py-2 rounded-xl bg-gradient-to-r from-[#49c5b6] to-[#3db6a7] text-white font-semibold shadow-md hover:from-[#3db6a7] hover:to-[#2ea89a] transition-all"
                  >
                    {t("Continue") || "Continue"}
                  </Button>
                </motion.div>
              ...
              {step === 2 && (
                <motion.div className="space-y-2" variants={itemVariants}>
                    ...
                    <FormField
                      ...
                      render={() => (
                        <FormItem>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-3 gap-2 sm:grid-cols-1 ">
                  ...
                  <div className="">
                    ...
                    <div className="mt-2 grid grid-cols-3 sm:grid-cols-3 md:grid-cols-3 gap-3 ">
                      <AnimatePresence>
                        {imageUrls.map((url, index) => (
                          <motion.div
                            ...
                            whileHover="hover"
                          >
                            <Card className="max-h-36 relative overflow-hidden rounded-xl shadow-md border border-gray-100">
                              <div className="aspect-square relative">
                                <Image
                                  src={url || "/placeholder.svg"}
                                  alt={`Item image ${index + 1}`}
                                  fill
                                  className="object-fill rounded-xl max-h-36"
                                />
                              </div>
                              <motion.div
                      ...
                      {images.length < MAX_IMAGES && (
                        ...
                        variants={imageUploadVariants} initial="hidden" animate="visible" whileHover="hover">
                          <Card className="flex w-full max-h-36 aspect-square items-center justify-center rounded-xl border border-dashed border-teal-300 bg-teal-50 hover:bg-teal-100 transition-all shadow-sm">
                            <CardContent className="flex h-full w-full flex-col items-center justify-center p-4">
                              <label htmlFor="image-upload" className="cursor-pointer text-center ">
                                <div className="mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-teal-200 ">
                                  <Upload className="h-6 w-6 text-teal-700" />
                                </div>
                                <p className=" text-xs -ml-3 text-teal-700 font-semibold text-center">{t("Clicktoupload") || "Click to upload"}</p>
                                <input
                                  id="image-upload"
                                  type="file"
 ...
 <Button
                    type="button"
                    onClick={() => setStep(1)}
                    className="w-full py-2 rounded-xl bg-gradient-to-r from-[#f2b230] to-[#967b43] text-white font-semibold shadow-md hover:from-[#ecb649] hover:to-[#8b5b3a] transition-all"

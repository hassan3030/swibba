...
export function ItemListingForm() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="flex items-center justify-center min-h-screen w-full py-2 bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-50"
    >
      <div className="container mx-auto px-4 py-8">
        <Form {...form}>
          <form
            ...
            className="space-y-2"
          >
            <div className="w-full max-w-lg mx-auto grid gap-2 md:grid-cols-1 rounded-2xl shadow-xl bg-white dark:bg-gray-900 p-4 sm:p-6 md:p-8 border border-gray-200 dark:border-gray-800">
              {step === 1 && (

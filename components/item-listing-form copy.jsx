...
export function ItemListingForm() {
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" className="bg-gradient-to-br from-gray-50 to-white min-h-screen py-8 px-2 md:px-8">
      <Form {...form}>
        <form
          onSubmit={(e) => form.handleSubmit((data) => onSubmit(data, e))(e)}
          className="space-y-10"
        >
          <div className="grid gap-10 md:grid-cols-2 rounded-2xl shadow-xl bg-white p-6 md:p-10">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <div className="flex items-center justify-between gap-2">
                        <FormLabel className="font-semibold text-gray-700">{t("aIExpectedPrice") || "Estimated Value"} ($)</FormLabel>
                        <TooltipProvider>
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <motion.div variants={buttonVariants} whileHover="hover" whileTap="tap">
                                <Button
                                  ...
                                  variant="outline"
                                  size="sm"
                                  onClick={() => {console.log("Requesting AI estimate.erdgfuoio.." , form.getValues("value_estimate")); }}

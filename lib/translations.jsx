export const translations = {
  en  :{
    ...
    ManageAllYourSwapsInOnePlace: "Manage all your swaps in one place",
    ...
    ItemsYouOffer: "Items you offer",
    ItemsYouReceive: "Items you receive",
    SendMessages: "Send messages to coordinate",
    WaitingForCompletion: "Waiting for completion",
    All: "All",
    Accepted: "Accepted",
    Rejected: "Rejected",
    noOffersWithStatus: "No offers with this status",
    noOffersMatchingFilter: "No offers match the selected filter. Try selecting a different status.",
...
InvalidswapornotloggedPleasetryagain:"Invalid swap or not logged in. Please try again.",
    ...
    searchOffers:"Search by user name...",
    egp:"LE",
    EGP:"LE",
...
SearchModels: "Search models...",
 Nomodelsfound: "No models found.",
    ...
    WaitingForResponse: "Waiting for response from the other user",
    ReadyToComplete: "The swap has been accepted. Ready to complete?",
...
IfCompletedSwapAllProductsHidden: "If the swap is completed, all products will be hidden",
    ...
    notAvailableForSwap: "Not Available for Swap",
    swapDescription: "This item is available for swapping. Make an offer now!",
    notAvailableDescription: "This item is currently not available for swapping.",
    acceptedCategories: "Accepted Categories",
    allCategories: "All Categories",
    noRecivedOffers: "No Received Offers Yet",
    NoSwapYet: "You haven't made any swaps yet",
    StartSwappingDescription: "Browse our products, find something you like, and make your first swap offer!",
    NoReceivedOffersDescription: "You're all caught up! New received offers will appear here when someone sends you a swap offer.",
...
SelectCountry: "Select a country",
  ...
  sendoffers:"Send Offers",
    ...
    ReviewOfferAndDecide: "Review the offer and make your decision",
    ...
    existing: "Existing",
    existingMedia: "existing media file(s)",
    all: "All categories",
   ...
   SelectCategory: "Select category",
    ...
    noProductsFound: "We couldn't find any products matching your criteria",
    ...
    noAvailableItems: "No Items Yet",
    noAvailableItemsDesc: "Start by adding your first item to swap with others. Your items will appear here once added.",
    noItemsInOffers: "No Items In Offers",
    noItemsInOffersDesc: "Your items will appear here when they're part of active swap offers. Start swapping to see your items here!",
    action: "Type",
  },
  ar: {
    // Offers Page
    SwapCenter: "مركز المبادلات",
    YourOffers: "عروضك",
    ManageAllYourSwapsInOnePlace: "إدارة جميع مبادلاتك في مكان واحد",
    ...
    ItemsYouOffer: "العناصر التي تقدمها",
    ItemsYouReceive: "العناصر التي ستستلمها",
    SendMessages: "أرسل رسائل للتنسيق",
    WaitingForCompletion: "في انتظار الإكمال",
    All: "الكل",
    Accepted: "مقبول",
    Rejected: "مرفوض",
    noOffersWithStatus: "لا توجد عروض بهذه الحالة",
    noOffersMatchingFilter: "لا توجد عروض تطابق الفلتر المحدد. جرب اختيار حالة مختلفة.",
...
InvalidswapornotloggedPleasetryagain:"تم إلغاء الاشتراك. أو لم يتم تسجيل الدخول. يرجى المحاولة مرة أخرى",
    ...
    searchOffers:"البحث باسم المستخدم...",
...
SearchModels: "ابحث عن النماذج...",
 Nomodelsfound: "لم يتم العثور على نماذج",
    ...
    WaitingForResponse: "في انتظار رد من المستخدم الآخر",
    ReadyToComplete: "تم قبول المبادلة. هل أنت مستعد للإتمام؟",
...
changeLanguageDescription:"تغيير اللغة من الإنجليزية إلى العربية والعكس.",
    ...
    availableForSwap: "متاح للمبادلة",
    notAvailableForSwap: "غير متاح للمبادلة",
    swapDescription: "هذا العنصر متاح للمبادلة. قدم عرضك الآن!",
    notAvailableDescription: "هذا العنصر غير متاح للمبادلة حاليًا.",
    acceptedCategories: "الفئات المقبولة",
    allCategories: "جميع الفئات",
    
    noRecivedOffers: "لا يوجد عروض مُستلمة حتي الآن",
    NoSwapYet: "لم تقم بأي مبادلة بعد",
    StartSwappingDescription: "تصفح منتجاتنا، ابحث عن شيء يعجبك، وقدم أول عرض مبادلة لك!",
    NoReceivedOffersDescription: "كل شيء على ما يرام! ستظهر العروض المستلمة الجديدة هنا عندما يرسل لك شخص ما عرض مبادلة.",
...
SelectCountry: "اختر الدولة",
  ...
  SetAFairMarketValue: "حدد قيمة سوق عادلة للمساعدة في تسهيل التبادلات المتوازنة.",
   ...
   Pleasefillallitemdetailsbeforeuploadingimages: "يرجى ملء جميع تفاصيل العنصر قبل تحميل الصور.",
    ...
    Myitems: " منتجاتي",
    CashAdjustment: " تعديل نقدي",
    ItemExchange: "تبادل العناصر",
    ReviewOfferAndDecide: "راجع العرض واتخذ قرارك",
    ...
    existing: "موجود",
    existingMedia: "ملف/ملفات وسائط موجودة",
    ...
    noProductsFound: "لم نتمكن من العثور على أي منتجات تطابق معاييرك",
    ...
    // Profile Empty States
    noAvailableItems: "لا توجد منتجات حتى الآن",
    noAvailableItemsDesc: "ابدأ بإضافة أول منتج للمبادلة مع الآخرين. ستظهر منتجاتك هنا بعد إضافتها.",
    noItemsInOffers: "لا توجد منتجات في العروض",
    noItemsInOffersDesc: "ستظهر منتجاتك هنا عندما تكون جزءًا من عروض المبادلة النشطة. ابدأ المبادلة لترى منتجاتك هنا!",
    action: "النوع",
